...
10. **WatchSafeArea only provides adaptive padding, no clip**: Every scrollable/list content area should use WatchSafeArea for adaptive circular-safe padding. The circular clip is handled globally by MaterialApp.builder — WatchSafeArea no longer clips. Top/bottom bars stay outside.
